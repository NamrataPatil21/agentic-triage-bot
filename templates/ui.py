...
if search_order_id:
    try:
        ...
        if lookup_res.status_code == 200:
            ...
            is_replaced = "REPLACEMENT" in status_upper or "DISPATCHED" in status_upper
            is_refunded = "REFUND" in status_upper and not is_replaced
            ...
            if is_replaced:
                ...
                status_flag = "🟢 " if "RESOLVED" in status_upper else "🔵 "
